...
public class KeywordTask implements Runnable {
    ...
    public KeywordTask(ConcurrentLinkedDeque<File> concurrentFileListPhase1,
                       ConcurrentLinkedDeque<File> concurrentFileListPhase2,
                       Phaser phaser,
                       ConcurrentHashMap<String, Word> globalVoc,
    ...
    public void run() {
            ...
            while ((file = concurrentFileListPhase1.poll()) != null) {
                ...
                for (Word word : doc.getWords().values()) {
            ...
            while ((file = concurrentFileListPhase2.poll()) != null) {
                Document doc =
                        DocumentParser.parse(file.getAbsolutePath());
                List<Word> keywords = new ArrayList<>(doc.getWords().values());
    ...
    private static void addKeyword(ConcurrentHashMap<String, Integer> keywords, String word) {
